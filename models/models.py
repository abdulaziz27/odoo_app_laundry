...
class LaundryOrder(models.Model):
    ...
    def print_laundry_order(self):
        return self.env.ref('laundry.action_laundry_order').report_action(self)

    def print_laundry_label(self):
        return self.env.ref('laundry.action_laundry_label').report_action(self)

    def print_receipt(self):
        return self.env.ref('laundry.action_report_receipt').report_action(self)